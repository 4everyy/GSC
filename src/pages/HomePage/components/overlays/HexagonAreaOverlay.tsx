...
import {
  ...
  computeHexInfo,
  type HexGeometry,
} from './hexagonArea/geometry'
import {
  useConfirmedPanel,
  projectVertices,
  type VertexLL,
} from './hexagonArea/useConfirmedPanel'
import { useEditHandles } from './hexagonArea/useEditHandles'
import { useEditAreaRequest } from './hexagonArea/useEditAreaRequest'
import { HexagonDrawingSvg } from './hexagonArea/HexagonDrawingSvg'
import { HexagonEditVisuals } from './hexagonArea/HexagonEditVisuals'
import { HexagonTypePanel } from './hexagonArea/HexagonTypePanel'
