...
import aircraftYellow from './aircraft-yellow.png'
...
import alarmPanelBg from './alarm-panel-bg.png'
import alarmPanelFrame from './alarm-panel-frame.png'
import alarmSymbol from './alarm-symbol.png'
import devicePanelFrame from './device-panel-frame.png'
import emergencyBtnBg from './emergency-btn-bg.png'
...
import statusBarNew from './status-bar-new.png'
import statusOnlineIcon from './status-online-icon.png'
import statusTakeoffIcon from './status-takeoff-icon.png'
import stopBtnBg from './stop-btn-bg.png'
import toolbarBtnActive from './toolbar-btn-active.png'
import toolbarBtnHover from './toolbar-btn-hover.png'
import toolbarBtnNormal from './toolbar-btn-normal.png'
